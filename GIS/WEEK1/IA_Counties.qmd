...
REQUIRED: A summary of the intentions with which the data set was developed.</abstract>
  ...
  <links>
    <link description="" name="Shapefile" mimeType="" url="file://\\DGRLGM71\C$\Essential GIS\Data\Iowa-Statewide data\Counties" format="" size="" type="Local Area Network"/>
  </links>
  <fees></fees>
  ...
  <extent>
    <spatial maxx="736849.21039300004485995" maxz="0" crs="EPSG:4326" minx="202073.80872299999464303" maxy="4822673.78653900045901537" minz="0" dimensions="2" miny="4470598.39718599990010262"/>
    <temporal>
      <period>
        <start></start>
        <end></end>
