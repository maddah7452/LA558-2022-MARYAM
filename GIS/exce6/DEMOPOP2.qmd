...
REQUIRED: A summary of the intentions with which the data set was developed.</abstract>
  ...
  <links>
    <link description="" mimeType="" format="" name="Shapefile" type="Local Area Network" url="file://\\DGRLGM71\C$\Essential GIS\Data\Iowa-Statewide data\Counties" size=""/>
  </links>
  <fees></fees>
  ...
  <extent>
    <spatial minz="0" minx="202073.80872299999464303" dimensions="2" miny="4470598.39718599990010262" maxx="736849.21039300004485995" maxy="4822673.78653900045901537" crs="EPSG:4326" maxz="0"/>
    <temporal>
      <period>
        <start></start>
        <end></end>
